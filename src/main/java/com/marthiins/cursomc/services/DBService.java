...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria (null, "Peças Carro");
        ...
        produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)); // criar a Lista para salvar todos os produtos no banco de dados
	    ...
	    Cliente cli1 = new Cliente(null, "Maria Silva", "sergio.marthiins@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
	    cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
	    

		Cliente cli2 = new Cliente(null, "Sergio Marthins", "sergiomartthins@gmail.com", "86563549063", TipoCliente.PESSOAFISICA, passwordEncoder.encode("1234"));
		cli2.getTelefones().addAll(Arrays.asList("27363325", "996150767"));
		cli2.addPerfil(Perfil.ADMIN);
	    
	    //os endereços conhece a cidade e os clientes
	    Endereco e1 =new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
	    Endereco e2 =new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
	    Endereco e3 = new Endereco(null, "Avenida das Perdizes", "412", "Casa", "Santa Barbara", "7370000", cli2, c2);
	   ...
	   //Associar o cliente para conhecer os endreços
	    ...
	    //Salvar na Base da Dados temos que criar um repository
