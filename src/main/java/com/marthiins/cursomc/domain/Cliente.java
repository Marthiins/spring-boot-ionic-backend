...
public class Cliente implements Serializable {
	...
	@Column(unique = true)//essa anotação faz com que o banco de dados não haja repetição, uma forma de dizer que esse campo vai ser uma chave canditada
	...
	@JsonIgnore//@JsonBackReference por motivo de erro troquei por @jsonIgnore
	...
	public Set<Perfil> getPerfis() {
		return perfis.stream().map(x -> Perfil.toEnum(x)).collect(Collectors.toSet()); //Código Lambda para retornar os perfil do cliente
	}
